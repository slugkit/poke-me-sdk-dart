...
4. Enter your Android package name: `com.example.app`
...
4. Enter description (e.g. "poke") and bundle ID: `com.example.app`
...
2. Select your App ID (`com.example.app`)
...
Register a separate App ID for macOS at [Identifiers](https://developer.apple.com/account/resources/identifiers/list) if you want a distinct bundle ID for macOS. Otherwise, the same `com.example.app` works.
...
1. Open **Settings → Notifications → <your app>**
2. Enable **Allow Notifications**

On Android 13+, the notification permission can be re-requested, or the user can enable it in **Settings → Apps → <your app> → Notifications**.
