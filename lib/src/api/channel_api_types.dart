// Channel-layer DTOs for the poke-me backend HTTP API (v1 consumer model:
// join-key / routing-key subscribe and the channel-centric device views).
//
// These surface through `package:pokeme/channels.dart`, not the core barrel —
// a BYOA consumer that only registers and identifies never sees them. Core
// transport types (DevicePlatform, UpdatePushTokenRequest) live in
// `api_types.dart`.
//
